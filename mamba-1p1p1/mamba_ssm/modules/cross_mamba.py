...
class Mamba(nn.Module):
    ...
    def forward(self, hidden_states, style, inference_params=None):
        """
        hidden_states: (B, L, D)
        ...
        # xz = torch.cat((self.in_proj_img.weight @ rearrange(hidden_states, "b l d -> d (b l)"), self.in_proj_style.weight @ rearrange(style, "b l d -> d (b l)")),0)
        # xz = rearrange(xz,
        #                  "d (b l) -> b d l",
        #                  l=seqlen)
        ...
        #C = rearrange(self.in_proj_style(style), 'b d -> d b')
        C = None
